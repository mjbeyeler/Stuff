...
df=pd.read_csv("~/data/metaanalysis_colaus_skipogh_RE2C.txt", delimiter=" ", names=['rsid','beta1', 'se1', 'beta2', 'se2'])
...
df['P'] = stats.t.sf(np.abs(df['t_meta']), df.shape[0]-1)*2 # two-sided t-test
